...
::: warning Okta identifies people by their Okta profile, not by their Google account
...
1. In the [Google Cloud console](https://console.cloud.google.com/), create an OAuth client under **APIs & Services → Credentials → Create credentials → OAuth client ID**:

    | Field                    | Value                                                    |
    | ------------------------ | -------------------------------------------------------- |
    | Application type         | **Web application**                                      |
    | Authorised redirect URIs | `https://your-org.okta.com/oauth2/v1/authorize/callback` |
